  ...
  return (
    <div className="w-full flex flex-col items-center justify-center mt-[150px] px-4 overflow-hidden">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="bg-gray-800 border border-neutral-700 rounded-3xl shadow-lg w-full lg:w-1/3 p-8 flex flex-col justify-center">
        ...
        <div className="bg-gray-800 border border-neutral-700 rounded-3xl shadow-lg w-full lg:w-2/3 p-8 flex items-center justify-center">
